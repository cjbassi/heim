...
At the moment, `heim` is not dependant on any async runtime, but it may need to be in the future
and if so it will most likely be a runtime compatible with the [runtime](https://crates.io/crates/runtime) crate.
